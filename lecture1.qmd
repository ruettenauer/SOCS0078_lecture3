---
title: "Macro-Economic Perspectives on Climate Change"
...
- Reformulation by @Grossman.1995 applying the KC to environmental issues within a neoclassical tradition.
...
- Efficient technologies are adopted to increase yields per unit of labour
    - decreasing emissions,
    - but displacing workers.
- Workers, fearing unemployment, support increased production, creating a cycle.
- Governments support increased production for tax revenues.
- The treadmill increases environmental impacts through resource demands and waste.
:::

[@Schnaiberg.2002; @York.2003]
...
::: {.incremental}
- Schnaiberg argues that producers won't internalize environmental costs willingly, as it reduces profits.
- Reform-oriented actions may not significantly alter producer power or reduce environmental externalities.
- The solution, according to the treadmill perspective, is to restructure society to limit producer hegemony.
- Efficiency-improving technology, in contrast, ultimately leads to increased impacts due to reinvestment in production.
:::
